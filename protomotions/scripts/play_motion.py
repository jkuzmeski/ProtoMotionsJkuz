...
#     extra_args: str = "", 
# ):
#     command = f"python protomotions/eval_agent.py +base=[fabric,structure] +exp=deepmimic_mlp +robot=smpl +simulator=isaaclab +checkpoint=null +training_max_steps=1 +motion_file=D:\\Isaac\\IsaacLab2.1.2\\ProtoMotions\\data\\motions\\smpl_humanoid_walk.npy env.config.sync_motion=True ref_respawn_offset=0 +headless=False num_envs={num_envs} {extra_args} +experiment_name=debug"
#     os.system(command)
